...
silent only
cd ~/choose_your_own/codes/process-spawn
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 process-spawn.markdown
args process-spawn.markdown
edit process-spawn.markdown
...
setlocal tabstop=2
setlocal tags=~/choose_your_own/.git/markdown.tags,~/choose_your_own/.git/tags,./tags,tags
